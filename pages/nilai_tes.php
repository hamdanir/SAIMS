                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="proses_diterima.php?id=<?php echo $d['id_pendaftaran']; ?>" onclick="return confirm('Apakah yakin Akan Menerima <?php echo $d['nama'];?> ?')">
                                    <button type="button" class="btn btn-outline-success btn-fw">Diterima</button>
                                    </a>

                                    <a href="proses_ditolak.php?id=<?php echo $d['id_pendaftaran']; ?>" onclick="return confirm('Apakah yakin Akan menolak <?php echo $d['nama'];?> ?')">
